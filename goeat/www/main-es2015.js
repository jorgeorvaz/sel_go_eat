...
/* harmony import */ var _guard_guard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./guard.guard */ "./src/app/guard.guard.ts");
...
const routes = [
    ...
    {
        path: 'login',
        loadChildren: () => Promise.all(/*! import() | login-login-module */[__webpack_require__.e("common"), __webpack_require__.e("login-login-module")]).then(__webpack_require__.bind(null, /*! ./login/login.module */ "./src/app/login/login.module.ts")).then(m => m.LoginPageModule), canActivateChild: [_guard_guard__WEBPACK_IMPORTED_MODULE_3__["GuardGuard"]]
    },
    {
        path: 'registro',
        loadChildren: () => Promise.all(/*! import() | registro-registro-module */[__webpack_require__.e("common"), __webpack_require__.e("registro-registro-module")]).then(__webpack_require__.bind(null, /*! ./registro/registro.module */ "./src/app/registro/registro.module.ts")).then(m => m.RegistroPageModule), canActivateChild: [_guard_guard__WEBPACK_IMPORTED_MODULE_3__["GuardGuard"]]
    },
    {
        path: 'inicio',
...
/* harmony import */ var _environments_firebaseConfig__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../environments/firebaseConfig */ "./src/environments/firebaseConfig.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            angularfire2__WEBPACK_IMPORTED_MODULE_10__["AngularFireModule"],
            ...
            angularfire2__WEBPACK_IMPORTED_MODULE_10__["AngularFireModule"].initializeApp(_environments_firebaseConfig__WEBPACK_IMPORTED_MODULE_13__["firebaseConfig"])
        ],
        providers: [
    ...
    loginUser(usuario) {
        return new Promise((resolve, reject) => {
            this.afAuth.auth.signInWithEmailAndPassword(usuario.email, usuario.password)
                .then(res => resolve(), err => reject(alert('Ese usuario no existe')));
        });
    }
    logoutUser() {
        return new Promise((resolve, reject) => {
...
AuthService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [angularfire2_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuth"]])
], AuthService);
...
GuardGuard = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["NavController"]])
], GuardGuard);
...
module.exports = __webpack_require__(/*! D:\Practicas\aplicacion_final\sel_go_eat\goeat\src\main.ts */"./src/main.ts");
